...
system.time((distances1 = nearestClassDistances(classes,  voxelsize=c(x,y,z), classes=7, cores=16L)),gcFirst=TRUE)
#system.time((distances2 = nearestClassDistances2(classes,  voxelsize=c(x,y,z), classes=7, cores=16L)),gcFirst=TRUE)
system.time((distances3 = nearestClassDistances3(classes,  voxelsize=c(x,y,z), classes=7, cores=16L)),gcFirst=TRUE)
