...
system.time(distances = nearestClassDistances(classes,  voxelsize=c(x,y,z), classes=7, cores=24L))
system.time(distances = nearestClassDistances2(classes,  voxelsize=c(x,y,z), classes=7, cores=24L))
system.time(distances = nearestClassDistances3(classes,  voxelsize=c(x,y,z), classes=7, cores=24L))
```
